...
RadioGroupBox = QLabel('Варианты ответов')
...
layout_res.addWidget(lb_Result, alignment=(Qt.AlignLeft | Qt.AlignVCenter))
...
#layout_card.addWidget(layout_line1, stretch=2)
